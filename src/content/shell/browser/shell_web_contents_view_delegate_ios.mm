...
void ShellWebContentsViewDelegate::ShowContextMenu(
  ...
  // iOS-15 port: -[UIControl performPrimaryAction] is iOS 17.0+. Calling it on
  // iOS 15/16 is an unrecognized selector and crashes the app on EVERY
  // long-press (any page). Guard it; on older iOS we just don't show the
  // programmatic context menu instead of crashing.
