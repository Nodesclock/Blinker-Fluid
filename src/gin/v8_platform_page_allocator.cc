...
#if BUILDFLAG(IS_IOS)
      // iOS rejects Chromium's MAP_JIT-backed reservation mode on this
      // TrollStore environment. Reserve ordinary inaccessible address space;
      // V8 will explicitly change permissions when committing code pages.
