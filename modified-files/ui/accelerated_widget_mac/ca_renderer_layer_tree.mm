    ...
    switch (io_surface_color_space.GetTransferID()) {
      case gfx::ColorSpace::TransferID::HLG:
        CVBufferSetAttachment(cv_pixel_buffer.get(),
                              ...
                              kCVAttachmentMode_ShouldPropagate);
        // kCVImageBufferAmbientViewingEnvironmentKey is iOS 15+/macOS 12+
        // (weak, NULL on iOS 14). Only attach the HLG
        // ambient-viewing-environment metadata where the key exists.
