          ...
          client_task_runner->PostTask(
              ...
              base::BindOnce(
                  [](gpu::SurfaceHandle view_handle,
                    ...
                    // CALayerFrameSinkProvider is now a plain UIView
                    // (BELayerHierarchyHostingView.handle no longer exists).
                    // This BEK multi-process display handoff is unused in the
